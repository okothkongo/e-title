defmodule ETitle.Accounts.Account do
  ...
  @registry_roles [:land_registrar, :registry_clerk]
  @land_board_roles [:land_board_clerk, :land_board_chairperson]
  @professional_roles [:surveyor, :lawyer]
  @all_roles [:user, :admin] ++ @registry_roles ++ @land_board_roles ++ @professional_roles
